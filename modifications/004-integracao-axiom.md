...
`Axiom::LogDevice` bufferiza (100 linhas ou 5s) e `Axiom::Logger` emite Hash estruturado. Anexado via `Rails.logger.broadcast_to`, **apenas em produção**, sem tocar no logger de stdout existente.
