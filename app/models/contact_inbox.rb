...
#  index_contact_inboxes_on_inbox_id_and_whatsapp_bsuid           (inbox_id,whatsapp_bsuid) UNIQUE WHERE (whatsapp_bsuid IS NOT NULL)
#  index_contact_inboxes_on_inbox_id_and_whatsapp_parent_bsuid    (inbox_id,whatsapp_parent_bsuid) WHERE (whatsapp_parent_bsuid IS NOT NULL)
